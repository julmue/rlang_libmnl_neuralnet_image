...
# image aquisition
marylin <- read.pnm("C:\\Users\\jmueller\\Desktop\\PresentationANN\\pic\\Marylin_crop_small.pgm")
...
x <- round(runif(2000, min = 1, max = 100), digits = 0)   # 2000
y <- round(runif(2000, min = 1, max = 100), digits = 0)   # 2000
smp <- data.frame(x, y)
...
#
smpImg <- matrix(0, nrow = 100, ncol = 100)
...
smpImgTrainSize <- floor(0.5 * nrow(smp))
